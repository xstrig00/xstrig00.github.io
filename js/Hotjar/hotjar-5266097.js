window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["ask.popover_redesign", "client_script.compression.pc", "csq_theme", "error_reporting", "feedback.embeddable_widget", "feedback.widgetV2", "settings.billing_v2", "survey.embeddable_widget", "survey.image_question", "survey.screenshots", "survey.type_button"],
...
!function() {
    ...
    var o, s = function() {
        ...
        var r;
        l.loggedMetrics[e] = a(a({}, l.loggedMetrics[e]), {}, ((r = {})[t] = n || {},
        r))
    }, d = function(e) {
        if (!e)
            return "value";
        ...
        return "lab" === e && (n = c.browser.inLab),
        "field" === e && (n = l.isFieldMetricsEnabled),
        t ? n && t.flush : n
    }, h = function(e) {
        var t = !1
          , n = "v=".concat(c.version)
          , r = "".concat(c.metricsUrl, "?").concat(n, "&site_id=").concat(window.hjSiteSettings.site_id) + (l.isDebugEnabled ? "&debug=true" : "")
          , i = JSON.stringify(e);
        ...
        start: function() {
            try {
                ...
                var e = p.time()
                  ...
                  , a = new Set(n)
                  , u = c.sampling;
                return l.genericTags = {
                    site_id: r
                },
                l.isDebugEnabled = Math.random() <= u.universalDebug || a.has("client_script.metrics.debug") && Math.random() <= u.debug,
                l.isMetricsEnabled = Math.random() <= u.metrics,
                l.isFieldMetricsEnabled = l.isMetricsEnabled && Math.random() <= u.fieldMetrics,
        ...
        count: function(e, t) {
            var n = t.incr
              ...
              , s = t.type;
            try {
                var c, u = d(r), h = l.loggedMetrics[e], p = 0;
                if (n ? (p = (h && h[u] || 0) + (n.value || 1),
                l.loggedMetrics[e] = a(a({}, h), {}, ((c = {})[u] = null != n && n.flush ? 0 : p,
                c))) : p = 1,
                f(s, n)) {
                    var m = {
                        name: e,
        ...
        timeIncr: function(e, t) {
            var n, r, i, a, o = t.tag, s = t.start, c = t.flush, g = t.extraTags, f = t.type, h = hj.metrics.time(), m = s && h ? h - s : void 0, v = (n = e,
            {
                tagName: r = d(o),
                start: (a = (i = l.loggedMetrics[n]) && i[r] || {}).start,
                total: a.total
            }), w = m ? m + (v.total || 0) : v.total;
            return u(e, v.tagName, {
                total: w
            }),
            c && p.timeEnd(e, {
                tag: o,
    ...
    if (window.hjLazyModules = window.hjLazyModules || {
        ...
        SURVEY_ISOLATED: {
            js: "survey-isolated.a34bbe0ea334bf520b66.js"
        },
        HEATMAP_RETAKER: {
            js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js"
        },
        SURVEY_INVITATION: {
            js: "survey-invitation.b7982e012811b2fcf55b.js"
        },
        NOTIFICATION: {
    ...
    U)
        ...
        var B = (O = (S = window.hjSiteSettings).suppress_all || S.suppress_text || (null === (T = S.suppress_all_on_specific_pages) || void 0 === T ? void 0 : T.length),
        x = function(e) {
            var t, n, r, i, a, o = {
            ...
            if ((e.suppress_all || e.suppress_text) && (o.anonymisationMethod = b.replayRecordingMaskedUrlRegex,
        ...
        I = x.replayRecordingMaskedUrlRegexRules,
        {
            CS_CONF_BASE: {
                ...
                smbConfig: {
                    siteId: S.site_id,
                    useCSTC: !0,
                    csLiteDomain: null !== (E = _hjSettings) && void 0 !== E && E.environment && "live" !== _hjSettings.environment ? "insights-integration.live.eks.hotjar.com" : "insights.hotjar.com"
                },
                ...
                implementations: (M = S,
                m(v, (N = M.state_change_listen_mode,
                "manual" === N ? [] : [{
                    template: {
                    ...
                    triggers: [{
                        name: "HistoryChange",
                        args: {
                            listeners: "popstate, pushState, replaceState" + ("automatic_with_fragments" === N ? ", hashchange" : ""),
                            useDebounce: "no",
                            window: 400
                        }
                    }]
        ...
        L && window._uxa.push(["setPIISelectors", {
            PIISelectors: L
        }]);
        var F = window._hjSettings.environment
          , z = "t.contentsquare.net";
        F && "live" !== F && (window._hjSettings.csid && (window.CS_CONF_BASE.projectId = window._hjSettings.csid),
