...
( () => {
    ...
    var e, t, o = {
        955: (e, t, o) => {
            ...
            const s = e => i(void 0, [e], void 0, (function*({config: e, sessionId: t, visitorId: o}) {
                const i = {
                    key: e.projectKey,
                    sessionId: t,
                    visitorId: o
                ...
                const {data: s, response: a} = yield r.F("/rec/setup-recording/website", {
                    method: "POST",
                ...
                return s.ok && s.recordingAllowed ? (e.isRelayProxy && (s.recording.assetsHost = n.c(e.host, "/assets").toString(),
                s.recording.writerHost = n.c(e.host, "/web-writer").toString()),
                {
                    response: a,
                    setupData: s
                }) : {
              ...
              , a = e => i(void 0, [e], void 0, (function*({managerHost: e, projectKey: t, sessionId: o}) {
                const {data: n} = yield r.F(`/rec/sessions/${o}/active?projectKey=${t}`, {
                    method: "GET",
              ...
              , d = e => i(void 0, [e], void 0, (function*({assetsHost: e, urls: t}) {
                yield r.F("/cache", {
                    method: "POST",
                    abortPreviousRequest: !1,
                    baseUrl: e,
              ...
              , l = ({assetsHost: e, urls: t}) => r.T("/cache", {
                baseUrl: e,
                body: JSON.stringify(t)
            })
              , c = e => i(void 0, [e], void 0, (function*({formData: e, isFromPreviousRecord: t, recordId: o, sessionId: n, visitorId: i, writerHost: s}) {
                let a = "/rec/v3/write";
                if (window.URLSearchParams) {
                    const e = new URLSearchParams([["rid", o], ["sid", n], ["vid", i]]);
                    t && e.append("isFromPreviousRecord", "true"),
                    a += `?${e.toString()}`
                }
                const {data: d} = yield r.F(a, {
                    method: "POST",
                    abortPreviousRequest: !1,
                    baseUrl: s,
                    body: e,
              ...
              , u = ({formData: e, isPartialChunk: t, recordId: o, retryCount: n, sessionId: i, visitorId: s, writerHost: a}) => {
                let d = "/rec/v3/write";
                if (window.URLSearchParams) {
                    const e = new URLSearchParams([["rid", o], ["sid", i], ["vid", s], ["isPartialChunk", String(t)]]);
                    t || e.delete("isPartialChunk"),
                    d += `?${e.toString()}`
                }
                return r.T(d, {
                    baseUrl: a,
        ...
        915: (e, t, o) => {
            ...
            const n = e => {
                if (e && "object" == typeof e && Object.hasOwn(e, "name")) {
                    const t = e.name;
                    if ("string" == typeof t && t.startsWith("SL__"))
                        return !0
                }
                return !1
            }
            ...
            const r = e => {
              ...
              , n = e => {
                ...
                for (const [o,r] of Object.entries(e))
                    null !== r && "number" != typeof r && "string" != typeof r && "boolean" != typeof r || (t[o] = r);
        ...
        757: (e, t, o) => {
            ...
            const l = (e, t, o) => d(void 0, void 0, void 0, (function*() {
                try {
                    return s.R.debug("Calling active endpoint in init."),
                    yield(0,
                    a.t9)({
                    ...
                    e instanceof r.h ? (e.isConnectionError || s.R.warn("/active call failed on network error.", e),
                    404 === e.status && o.clearStorage()) : e instanceof n.f ? e.shouldReport && s.R.warn("/active call failed on recorder error.", e) : s.R.warn("/active call failed on unknown error.", e)
                }
                return null
            }
            ))
        ...
        321: (e, t, o) => {
            ...
            var r, n = o(257), i = o(283);
            !function(e) {
                e.CLICK = "click",
                e.CUSTOM_EVENT = "custom event",
                e.IDENTIFY = "identify",
                e.PROPERTIES = "global event"
            }(r || (r = {}));
            const s = (e, t, o) => {
                (0,
                i.Nu)(e, t);
        ...
        480: (e, t, o) => {
            ...
            const n = e => {
                const t = (0,
                r.Qd)(e) ? JSON.stringify(e) : String(e);
              ...
              , i = e => {
                ...
                return e.forEach(( (e, o) => {
                    t += o.length,
                    t += "string" == typeof e ? e.length : e.size
                }
                )),
                t
            }
        ...
        283: (e, t, o) => {
            ...
            const l = "https://web.developer.smartlook.com/docs"
              ...
              , v = e => (0,
            r.Kg)(e) && e.length > 0 && e.length <= 200
              , m = e => (0,
            d.q)(e) <= 5e3
              , w = (e, t) => {
                const o = e.trim();
                return o !== e && (0,
                i.o)(`Invalid format of string '${o}'. Please remove spaces at the beginning or at the end of the string. See more at ${k(t)}.`),
                o
            }
              , y = (e, t) => {
                const o = n.NC(e);
                ...
                s.Qd)(o)) {
                    ...
                    (0,
                    i.o)(`Invalid type of ${t} properties. Expected plain object, got ${e}. See more at ${k(t)}`)
                }
                var r
            }
              , b = (e, t, o="") => {
                ...
                for (const [n,s] of Object.entries(e)) {
                    ...
                    e) {
                        ...
                        (0,
                        i.o)(`${o ? `${o}: ` : ""}Invalid name of ${t} property '${n}'. See more at ${k(t)}`);
                    a || (0,
                    i.o)(`${o ? `${o}: ` : ""}Invalid value of ${t} property '${n}' (${typeof s}). See more at ${k(t)}`, s)
                }
                return r
            }
              , S = e => v(e) ? w(String(e), a.w.CUSTOM_EVENT) : ((0,
            i.o)(`Invalid custom event name '${e}'. See more at ${g}`),
            e)
              , R = e => {
                var t;
                if (t = e,
                ...
                d.q)(t) <= 5e3)
                    return e;
                (0,
                i.o)(`Invalid error message. See more at ${u}`)
            }
              , E = e => {
                if ((e => (0,
                r.Kg)(e) && e.length > 0 && e.length <= 1e3)(e))
                    return e;
                (0,
                i.o)(`Invalid navigation url '${e}'. See more at ${p}`)
            }
              , k = e => {
                var t;
                return null !== (t = {
            ...
            const a = ["mousemove", "click", "keypress", "touchmove", "drag", "wheel", "mouseover"]
              , d = e => {
                return o = function*() {
                    ...
                    e && l.push(e.waitForEventFromAnySource(s.g4.USER_ACTIVITY)),
                    yield Promise.any(l);
                    for (const e of d)
                        try {
                            e()
        ...
        311: (e, t, o) => {
            ...
            class n {
                ...
                constructor() {}
                debug = (e, ...t) => {
                    this.processMiddlewares("console", "debug", e, ...t),
                    null !== this.loggingLevel && r.DEBUG >= this.loggingLevel && console.debug(e, ...t)
                }
                ;
                debugGroup = (e, ...t) => {
                ...
                ;
                enableGroupLogging = () => {
                    this.isGroupLoggingEnabled = !0,
                    null !== this.groupLoggingIntervalId && (this.groupLoggingIntervalId = setInterval(( () => {
                ...
                ;
                error = (e, ...t) => {
                    this.processMiddlewares("console", "error", e, ...t),
                    null !== this.loggingLevel && r.ERROR >= this.loggingLevel && console.error(e, ...t)
                }
                ;
                errorGroup = (e, ...t) => {
                ...
                ;
                info = (e, ...t) => {
                    this.processMiddlewares("console", "info", e, ...t),
                    null !== this.loggingLevel && r.INFO >= this.loggingLevel && console.log(e, ...t)
                }
                ;
                infoGroup = (e, ...t) => {
                ...
                ;
                warn = (e, ...t) => {
                    this.processMiddlewares("console", "warn", e, ...t),
                    null !== this.loggingLevel && r.WARN >= this.loggingLevel && console.warn(e, ...t)
                }
                ;
                warnGroup = (e, ...t) => {
        ...
        409: (e, t, o) => {
            ...
            class r extends Error {
                ...
                constructor(e, t, o, n, i, s, a, d, l) {
                    ...
                    this.requestPayload = i,
                    this.originalError = a,
                    this.responseData = d,
                    this.additionalData = l,
                    this.name = "ApiError",
                    Object.setPrototypeOf(this, r.prototype),
                    this.responseDebugData = s ? (e => ({
                        type: e.type,
                        bodyUsed: e.bodyUsed,
                    ...
                    this.isSignalAborted = null == n ? void 0 : n.aborted,
        ...
        665: (e, t, o) => {
            ...
            const l = {
              ...
              , g = (e, t) => d(void 0, void 0, void 0, (function*() {
                var {abortPreviousRequest: o, baseUrl: d, body: g, doNotRetryOnDocumentHidden: f=!1, headers: h, logPayloadOnError: p=!1, retryCount: v=3, retryInterval: m=1e3, throwOnConvert: w=!1, waitForOnlineStatus: y=!1} = t
                  , b = function(e, t) {
                    var o = {};
                    for (var r in e)
                ...
                i.c)(d, e);
                let R = u.get(S.href);
                R && o && (n.R.debug("Aborting previous request", S),
                ...
                let O, I = null, A = performance.now(), M = 0, L = -1;
                for (let e = 1; e <= v; e++) {
                    y && (yield s()),
                    L = e;
                    try {
                        if (1 === e)
                            ...
                            f) {
                                const e = new Promise((e => {
                                    const t = () => {
                                        "hidden" === document.visibilityState && (document.removeEventListener("visibilitychange", t),
                                        e())
                                    }
                                    ;
                            ...
                            if (yield Promise.race(t),
                            f && "hidden" === document.visibilityState)
                        ...
                        t instanceof Error && "AbortError" === t.name)
                            throw u.delete(S.href),
                            new a.h("Request was aborted.",-1,{
                                fetchTotalMs: M,
                                finalRetries: L
                            },R.signal,p ? JSON.stringify(g) : "Payload not logged.",void 0,t);
                        if (e < v && (!f || "hidden" !== document.visibilityState))
                            continue
                    } finally {
                        M = performance.now() - A
                    }
                    if (u.delete(S.href),
                    !k)
                        throw new a.h(`API request to ${S.href} failed due to connection error.`,-1,{
                            fetchTotalMs: M,
                            finalRetries: L
                    ...
                    try {
                        ...
                        if (t instanceof Error && ("AbortError" === t.name || "TypeError" === t.name) && e < v)
                            continue;
                        if (w && t instanceof Error)
                            throw "AbortError" === t.name || "TypeError" === t.name ? new a.h(`API request to ${S.href} failed due to connection error.`,-1,{
                                fetchTotalMs: M,
                                finalRetries: L
                        ...
                        if (w)
                            throw new r.f(`Unknown error happened during API call. ${JSON.stringify(t)}`);
                        break
                    }
                }
                if (void 0 === k)
                    throw new r.f("Response object is undefined.",{
                        shouldReport: !0
                    });
                return {
                    data: I,
              ...
              , f = (e, t) => d(void 0, [e, t], void 0, (function*(e, {baseUrl: t, body: o, retryCount: r=1, waitForOnlineStatus: n}) {
                const a = (0,
                i.c)(t, e)
        ...
        553: (e, t, o) => {
            ...
            const s = e => {
                try {
                    if ((0,
                    r.bJ)(e) && !Object.hasOwn(e, "toJSON"))
                        return a(e);
                    if ("object" == typeof e && null !== e) {
                        const t = Object.keys(e);
                        if (1 === t.length && "isTrusted" === t[0])
                            return a(e)
                    }
                    if (["function", "symbol", "bigint", "undefined"].includes(typeof e))
                        return a(e);
              ...
              , d = (e, t=new WeakMap) => {
                let o;
                return Array.isArray(e) ? e.map((e => d(e, t))) : (o = "object" == typeof e && null !== e ? e instanceof Element ? `[Element: ${e.tagName}]` : l(e, t) : ["function", "symbol", "bigint", "undefined"].includes(typeof e) ? typeof e : null === e || "number" == typeof e || "string" == typeof e || "boolean" == typeof e ? e : JSON.stringify(e),
                o)
            }
              , l = (e, t) => {
                let o;
              ...
              , g = e => {
                ...
                if (Array.isArray(e))
                    t = "[" + e.map((e => g(e))).join(",") + "]";
                else if ("function" == typeof e || (o = e)instanceof RegExp || "object" == typeof o && null !== o && "RegExp" === o.constructor.name)
                    t = e.toString();
                else if ("boolean" == typeof e || void 0 === e)
                    t = e;
        ...
        260: (e, t, o) => {
            ...
            const r = (e, t) => {
                ...
                if (!t)
                    return o;
                let n = o.pathname;
                return n.endsWith("/") && t.startsWith("/") && (n = n.slice(0, -1)),
                new URL(`${n}${t}`,o.origin)
            }
    ...
    ,
    n.f = {},
    n.e = e => Promise.all(Object.keys(n.f).reduce(( (t, o) => (n.f[o](e, t),
    t)), [])),
    n.u = e => "bundle.eccdb719246c73f4af95.js",
    ...
    class O {
        constructor(e, t, o, r, n, i) {
            this.projectKey = e,
            this.datadogHost = t,
            this.uploadInterval = o,
            this.version = r,
            this.additionalContext = n,
            this.logPrefix = i,
            ...
            this.uuid = (0,
            d.$)(),
            this.sendLog = (e, t, o, ...r) => {
                if ("error" === t || "internal" === e) {
                    const e = this.logMessagesCache.get(o)
                      , n = performance.now();
                    if (this.logMessagesCache.set(o, n),
                    void 0 !== e && n - e < 1e3)
                        return;
                    this.logsToSend.push(this.createLog(o, t, ...r)),
            ...
            this.createLog = (e, t, ...o) => {
                var r, n, i, s, a, d;
                const l = Object.fromEntries(o.map(( (e, t) => [t, JSON.parse((0,
                R.As)(e))])));
                return {
            ...
            ,
            this.handleError = e => {
                e.error instanceof a.f && e.error.shouldReport && (this.logsToSend.push(this.createLog(`Uncaught error: ${e.error}`, "error", e.error)),
                "hidden" === document.visibilityState && this.processLogs())
            }
            ,
            this.handlePromiseRejection = e => {
                ...
                if (e.reason instanceof a.f && e.reason.shouldReport) {
                    if ("string" == typeof (null === (t = e.reason.additionalData) || void 0 === t ? void 0 : t.message) && (e.reason.additionalData.message.includes("Cannot set properties of undefined (setting 'sessionManager')") || e.reason.additionalData.message.includes("undefined is not an object (evaluating 'this.sessionManager=e')") || e.reason.additionalData.message.includes("this is undefined") || e.reason.additionalData.message.includes("Unable to set property 'sessionManager' of undefined or null reference")))
                        return;
                    this.logsToSend.push(this.createLog(`Unhandled promise rejection: ${e.reason}`, "error", e.reason)),
                    "hidden" === document.visibilityState && this.processLogs()
                }
            }
            ,
            ...
            window.addEventListener("unhandledrejection", this.handlePromiseRejection, !0),
            document.addEventListener("visibilitychange", (e => {
                (0,
                E.Q)(e) && "hidden" === document.visibilityState && (this.processLogs(),
                setTimeout(( () => {
                    this.processLogs()
                }
                ), 500))
        ...
        processLogs() {
            ...
            o = function*() {
                if (!this.isSendingLogsDisabled && this.logsToSend.length > 0) {
                    ...
                    try {
                        yield(e => {
                            return t = [e],
                            r = function*({datadogHost: e, payload: t, projectKey: o}) {
                                yield(0,
                                k.F)(`/rec/log/${o}`, {
                                    method: "POST",
                                    abortPreviousRequest: !1,
            ...
            new ((t = void 0) || (t = Promise))((function(r, n) {
                ...
                function a(e) {
                    var o;
                    e.done ? r(e.value) : (o = e.value,
                    o instanceof t ? o : new t((function(e) {
                        e(o)
                    }
                    ))).then(i, s)
                }
    ...
    const I = (e, t) => {
        ...
        const r = o.split(".");
        let n = 0;
        for (; n < r.length - 1 && !e.cookie.includes(`${t}=true`); )
            n += 1,
            o = r.slice(-1 - n).join("."),
            e.cookie = `${t}=true;domain=${o};path=/;sameSite=strict;secure`;
        return e.cookie = `${t}=;expires=Thu, 01 Jan 1970 00:00:01 GMT;domain=${o};path=/;sameSite=strict;secure`,
        o
    }
    ;
    class A {
        ...
        setCookieProjectMetadata(e, t) {
            ...
            o[e] = t,
            this.setCookie(this.storageKeys.SMARTLOOK_COOKIE, JSON.stringify(o))
        }
        static getCookie(e) {
        ...
        static getCookieExpirationDate() {
            const e = new Date;
            return e.setMonth(e.getMonth() + 13),
            e.toUTCString()
        }
        removeCookie(e) {
    ...
    class T {
        constructor() {
            ...
            this.isDatabaseClosed = !1,
            this.numberOfUnexpectedCloses = 0,
            this.clearAssetsStore = () => M(this, void 0, void 0, (function*() {
                if (yield this.initializeIfNeeded(),
                !this.isDatabaseClosed)
                    try {
                        yield new Promise(( (e, t) => {
                            if (!this.database)
                                return void t(new a.f("IndexDB: Database not initialized"));
                            if (!this.database.objectStoreNames.contains(L))
                                return void e();
                            const o = this.database.transaction(L, "readwrite").objectStore(L).clear();
                            o.addEventListener("success", (t => {
                                i.R.debug("Success clearing asset store", t),
                                e()
                            }
                            )),
                            o.addEventListener("error", (e => {
                                i.R.debug("Error clearing asset store", e),
                                t("Error clearing store")
                            }
                            ))
                        }
                        ))
            ...
            this.getStoredAsset = e => M(this, void 0, void 0, (function*() {
                ...
                try {
                    return yield new Promise(( (t, o) => {
                        if (!this.database)
                            return void o(new a.f("IndexDB: Database not initialized"));
                        if (!this.database.objectStoreNames.contains(L))
                            return void t(null);
                        const r = this.database.transaction(L, "readonly").objectStore(L).get(e);
                        r.addEventListener("success", ( () => {
                            i.R.debug("Success reading asset data", r.result),
                            t(r.result)
                        }
                        )),
                        r.addEventListener("error", (e => {
                            i.R.debug("Error reading asset data", e),
                            o(new a.f("IndexDB: Error reading data"))
                        }
                        ))
                    }
                    ))
                } catch (e) {
                    return i.R.debug("Error reading asset data", e),
                    null
                }
            }
            )),
            this.storeAsset = e => M(this, void 0, void 0, (function*() {
                ...
                !this.isDatabaseClosed) {
                    ...
                    if ((yield this.getNumberOfStoredAssets()) >= 2e3)
                        i.R.debug("Max number of stored assets reached. Asset will not be stored.");
                    else
                        try {
                            yield new Promise(( (t, o) => {
                                ...
                                null == d || d.addEventListener("success", (e => {
                                    i.R.debug("Success writing asset data", e),
                                    t()
                                }
                                )),
                                null == d || d.addEventListener("error", (e => {
                                    ...
                                    "QuotaExceededError" === (null === (r = d.error) || void 0 === r ? void 0 : r.name) && (i.R.debug("QuotaExceededError occurred while writing data. Asset will not be stored and store will be cleared."),
                                    this.clearAssetsStore()),
                                    "DataCloneError" === (null === (n = d.error) || void 0 === n ? void 0 : n.name) && d.error.message.includes("BlobURLs are not yet supported.") && t(),
                                    o(new a.f("IndexDB: Error writing data"))
                                }
                                ))
                            }
                            ))
                ...
                try {
                    return yield new Promise(( (e, t) => {
                        ...
                        o.addEventListener("success", ( () => {
                            i.R.debug("Success reading asset store size", o.result),
                            e(o.result)
                        }
                        )),
                        o.addEventListener("error", (e => {
                            i.R.debug("Error reading asset store size", e),
                            t(new a.f("IndexDB: Error reading store size"))
                        }
                        ))
                    }
                    ))
                } catch (e) {
                    return i.R.debug("Error reading asset store size", e),
                    0
                }
            }
            ))
        ...
        initializeIfNeeded() {
            return M(this, void 0, void 0, (function*() {
                if (this.numberOfUnexpectedCloses > 5 || this.isDatabaseClosed)
                    ...
                    if (this.initializeDatabasePromise)
                        ...
                        this.initializeDatabasePromise = new Promise(( (e, t) => {
                            ...
                            o.addEventListener("error", (e => {
                                i.R.debug("Error occurred while opening IndexedDB database. IndexedDB is not available.", e),
                                t(new a.f("IndexDB: Error occurred while opening IndexedDB database. IndexedDB is not available."))
                            }
                            )),
                            o.addEventListener("success", (t => {
    ...
    class D {
        constructor(e, t) {
            ...
            this.removeFromLocalStorageProjectMetadata = (e, t) => {
                ...
                o[e] && (delete o[e][t],
                P(this.storageKeys.SMARTLOOK_LS, JSON.stringify(o)))
            }
            ,
        ...
        clearLocalStorage() {
            j(this.storageKeys.SMARTLOOK_LS),
            j(this.storageKeys.SMARTLOOK_BAN_REASON),
            j(this.storageKeys.SMARTLOOK_BAN_EXPIRE),
            j(this.storageKeys.SMARTLOOK_DEBUG),
            j(this.storageKeys.SMARTLOOK_LS_GLOBAL_PROPERTIES)
        }
        getBanExpire() {
        ...
        queueChunkToSend(e) {
            ...
            return o.push(e),
            P(this.storageKeys.SMARTLOOK_LS_QUEUED_CHUNKS, JSON.stringify(o))
        }
        removeBanExpire() {
            j(this.storageKeys.SMARTLOOK_BAN_EXPIRE)
        }
    ...
    class N {
        constructor({projectKey: e, storageKeys: t, useCookies: o}) {
            ...
            this.cookieManager = new A(t,o),
            this.localStorageManager = new D(e,t),
            this.idbStorageManager = new T
        }
        clearAssetsStore() {
        ...
        clearStorage() {
            ...
            this.idbStorageManager.clearStorage()
        }
        getBanExpire() {
    ...
    class K {
        getServerTime() {
            if (void 0 === this.lastServerTime || void 0 === this.relativeTimeSinceLastServerTimeSet)
                throw new a.f("Server time is undefined",{
                    additionalData: {
    ...
    class $ {
        ...
        updateProperties(e) {
            ...
            Object.assign(t, e),
            this.persistentStorageManager.setGlobalProperties((0,
            B.e)(t, B.w.PROPERTIES))
        }
    }
    class U {
        constructor() {
    ...
    class F {
        constructor(e, t, o, r) {
            if (this.persistentStorageManager = e,
            this.startRecording = t,
            this.stopRecording = o,
            this.config = r,
            ...
            this.isAppliedBan(!0)) {
                ...
                if (e) {
                    ...
                    t > 0 && (i.R.debug(`BAN is applied. Waiting ${t}ms.`),
        ...
        applyBan(e) {
            ...
            if (this.config.isCrossOriginIframeMode) {
                if (i.R.debug("Ban is not applied. Cross-origin mode detected."),
            ...
            e.shouldReport && (i.R.warnNoConsole(`Applying ban. Reason: "${e.message}".`, e),
            i.R.warn(`Applying ban. Reason: "${e.message}".`, e));
            const t = Date.now() + this.config.banTime;
            if (this.persistentStorageManager.setBanExpire(t.toString()),
            this.persistentStorageManager.setBanReason(e.message),
        ...
        isAppliedBan(e=!1) {
            if (!e)
                return void 0 !== this.banTimeoutId;
            const t = this.persistentStorageManager.getBanExpire();
            return !!(t && Number.parseInt(t, 10) > Date.now()) || (this.persistentStorageManager.removeBanExpire(),
            this.persistentStorageManager.removeBanReason(),
            !1)
        }
    }
        ...
        constructor(e) {
            ...
            this.isTherePendingEvent = (e, t) => {
                ...
                if (r) {
                    ...
                    if (t.length > 0)
                        return t.length > 1 && i.R.warn("Received multiple events. Taking first received."),
                        !0
                }
                return !1
            }
            ...
            this.sendEventToSource = (e, t) => {
                i.R.debug(`Sending ${e.name} event to different source.`, e),
                t.postMessage(e, "*")
            }
            ,
            this.waitForEventFromAnySource = e => G(this, void 0, void 0, (function*() {
                ...
                for (const o of this.pendingEventsByMessageEventSource.values()) {
                    ...
                    if (n.length > 0)
                        return n.length > 1 && i.R.warn("Received multiple events. Taking first received."),
                        o.set(e, r.filter((t => t.name !== e))),
                        n[0]
                }
                let o, r = this.waitingListenersByEventType.get(e);
                void 0 === r && (r = [],
                this.waitingListenersByEventType.set(e, r));
                const n = yield new Promise((e => {
                    r && (o = e,
                    r.push(e))
                }
                ));
                return o && (i.R.debug(`Removing event listener for "${e}".`),
                this.waitingListenersByEventType.set(e, r.filter((e => e !== o)))),
                n
            }
            )),
            this.waitForEventFromSource = (e, t) => G(this, void 0, void 0, (function*() {
                ...
                if (r) {
                    ...
                    if (n.length > 0)
                        return n.length > 1 && i.R.warn("Received multiple events. Taking first received."),
                        r.set(e, t.filter((t => t.name !== e))),
                        n[0]
                }
                let n = this.waitingListenersByEventTypeByMessageEventSource.get(t);
                void 0 === n && (n = new Map,
                this.waitingListenersByEventTypeByMessageEventSource.set(t, n));
                const s = yield new Promise((t => {
                    if (void 0 === n)
                        throw new a.f("listenersByWindow is undefined");
                    n.set(e, t)
                }
                ));
                return n.delete(e),
            ...
            this.postMessageEventListener = e => {
                ...
                p.GX)(t) && e.source) {
                    const o = e.source;
                    if (t.key !== this.projectKey)
                        return void i.R.debug("Received event with different key.", e);
                    (0,
                    p.MG)(t) && !this.isClosed && (i.R.debug("Received discovery. Sending discovered response", e),
                    ...
                    (0,
                    p.o7)(t) && !this.isClosed && (i.R.debug("Received discovered. Sending acknowledged response", e),
                    this.sendEventToSource({
                        name: p.g4.ACKNOWLEDGED,
                        key: this.projectKey
                    }, o),
                    this.discoveredIframeWindows.add(e.source));
                    ...
                    if (n) {
                        ...
                        e && (i.R.debug(`Found waiting listener for event - ${t.name}.`),
                        e(t))
                    }
                    const s = this.waitingListenersByEventType.get(t.name);
                    if (s && s.length > 0 && (i.R.debug(`Found waiting listener from any source for event - ${t.name}.`),
                    s.forEach((e => e(t)))),
                    n || r || s && s.length > 0)
                        return;
                    ...
                    if (a) {
                        ...
                        e ? (e.push(t),
                        a.set(t.name, e)) : a.set(t.name, [t])
                    } else {
                        const o = new Map;
                        o.set(t.name, [t]),
                        this.pendingEventsByMessageEventSource.set(e.source, o)
                    }
                }
            }
            ,
    ...
    class q {
        constructor(e) {
            ...
            ,
            this.getAppliedRetryAfterReason = () => this.persistentStorageManager.getSetupRetryAfterExpireReason(),
    ...
    let X, Z, ee = !1, te = !1, oe = !0;
    const re = [];
    let ne, ie, se, ae, de, le, ce, ue, ge, fe, he = [], pe = !1, ve = !1, me = 0, we = !1, ye = !1, be = !1;
    const Se = performance.now()
      , Re = (e, ...t) => Q(void 0, void 0, void 0, (function*() {
        var o, r, g, R, E, k, I, A;
        if (window.smartlook._loadInfo = window.smartlook._loadInfo || [],
        (e => {
            void 0 === window.smartlook._apiCallsHistory && (window.smartlook._apiCallsHistory = []),
            window.smartlook._apiCallsHistory.push(["function" == typeof e ? "function" : e, performance.now() - Se]),
            window.smartlook._apiCallsHistory.length > 15 && window.smartlook._apiCallsHistory.shift()
        }
        )(e),
        window.navigator.userAgent.includes("BingPreview") || window.navigator.userAgent.includes("adidxbot") || window.navigator.userAgent.includes("Bingbot"))
            (0,
            v.o)("Smartlook is disabled. Bot detected.");
        else {
            if ("init" === e && me < 1 || "reinit" === e) {
                if (fe = t[0],
                ge = null !== (o = t[1]) && void 0 !== o ? o : {},
                "string" == typeof fe && (fe = fe.trim()),
                void 0 === fe || "string" == typeof fe && 0 === fe.length)
                    return window.smartlook._loadInfo.push("Initialization unsuccessful. Project key is empty."),
                    (0,
                    v.o)("Smartlook could not be initialized. Provided project key is empty."),
                    void ("reinit" === e && (we = !1));
                if (ue = ( (e, t, o) => {
                    ...
                    if (o.host) {
                        ...
                        const e = u.c(o.host);
                        (!e.host.endsWith("smartlook.cloud") && !e.host.endsWith("smartlook.com") || e.host.endsWith("smartlook.cloud") && e.host.includes("relay-proxy")) && (r.managerHost = u.c(e.toString(), "/manager").toString(),
                        r.isRelayProxy = !0)
                    } else if (o.region) {
                        const e = f[o.region];
                        if (void 0 === e)
                ...
                if (!be) {
                    ...
                    !pe) {
                        ...
                        ae = e.persistentStorageManager,
                        de = e.propertiesManager,
                        ie = e.banService,
                        le = e.timeManager,
                        ce = e.scrollManager,
                        ne = e.postMessageService,
                        se = e.setupRetryAfterService,
                        pe = !0
                    }
                    be = !0;
            ...
            if (fe && y())
                if (i.R.debug("Smartlook loaded in parent window."),
                ee)
                    i.R.debug("Smartlook is already initialized in iframe. No API calls will be proxied.");
                else {
                    if (b(fe)) {
                        if (i.R.debug("Detected smartlook in parent window. API calls 'navigate', 'track', 'properties', 'navigation' and 'error' will be proxied there. All the other will be silently ignored."),
                        "string" == typeof e && ["track", "properties", "navigation", "error"].includes(e))
                            return i.R.debug(`Sending API call ${e} to parent window.`),
                            null === (r = window.parent) || void 0 === r ? void 0 : r.smartlook(e, ...t);
                        if ("init" === e) {
                    ...
                    if ("init" === e) {
                        if (i.R.debug("Waiting for smartlook in parent window to initialize."),
                        yield(I = void 0,
                        A = function*() {
                            let e;
                            yield new Promise((t => {
                                e = setInterval(( () => {
                                    var o, r;
                                    void 0 !== (null === (r = null === (o = window.parent) || void 0 === o ? void 0 : o.smartlook) || void 0 === r ? void 0 : r.key) && (void 0 !== e && (clearInterval(e),
                                    e = void 0),
                                    t())
                                }
                                ), 100)
            ...
            if ("visitor_blocked" === Z && ue && "identify" === e && !ye) {
                ye = !0;
                const [o] = t;
                if ("string" != typeof o && "number" != typeof o || "string" == typeof o && !o)
                    return (0,
                    v.o)(`Invalid user id passed to smartlook('identify', ...). Received: ${o}`),
                    void (ye = !1);
            ...
            if (!["init", "finish", "reinit"].includes(e) && (!ee || we))
            ...
            if ("init" === e || "reinit" === e) {
                if (void 0 === ue)
                    return void i.R.warn("Config is undefined.");
                if ("reinit" === e && (we = !0),
                "init" === e && (me += 1),
                me > 1) {
                    const o = t[0];
                    return "string" == typeof o && o.trim() !== ue.projectKey ? (window.smartlook._loadInfo.push("Initialization unsuccessful. Init API called twice with different project keys."),
                    (0,
                    v.o)(`Smartlook init method called twice with different project keys (${ue.projectKey}, ${o.trim()}).`)) : (window.smartlook._loadInfo.push("Initialization unsuccessful. Init called twice."),
                    i.R.debug(`Init called ${me}x times. Skipping initialization.`)),
                    void ("reinit" === e && (we = !1))
                }
                i.R.debug("Init called.");
                const o = t[2];
                if (ie.isAppliedBan())
                    return window.smartlook._loadInfo.push(`Initialization unsuccessful. BAN applied - ${ie.getBanReason()}`),
                    i.R.debug("BAN is applied. Initialization is postponed."),
                    o && o(),
                    void ("reinit" === e && (we = !1));
                (s.wp() || ue.standalone) && ue.startRecordingAfterUserActivity && (window.smartlook._loadInfo.push(`Initialization waiting for user activity. Start: ${Date.now()}`),
                yield(0,
                S.j)(ne),
                window.smartlook._loadInfo.push(`Initialization continues. User activity detected. Start: ${Date.now()}`)),
                he.length > 0 && "anonymize" === he[0][0] && (window.smartlook._loadInfo.push("Anonymize called straight after init. Clearing storage."),
                i.R.debug("Anonymize called straight after init. Clearing storage."),
                ae.clearStorage(),
                he.shift()),
                s.wp() || s.NM() || null === window.parent || ue.standalone || (ie.clearBanIfApplied(),
                Y = yield(M = ue,
                L = window.parent,
                Q(void 0, void 0, void 0, (function*() {
                    i.R.debug("Sending discovered event to parent window event.", window.location.href),
                    ne.sendEventToSource({
                        name: p.g4.DISCOVERED,
                        key: M.projectKey,
                        sessionId: void 0
                    }, window.parent);
                    try {
                        return i.R.debug("Waiting for acknowledged event from parent.", window.location.href),
                        yield ne.waitForEventFromSourceOrThrowAfterGivenTime(p.g4.ACKNOWLEDGED, window.parent),
                        (0,
                        S.j)().then(( () => {
                            void 0 !== ue && (i.R.debug("Sending user activity event to parent.", window.location.href),
                            ne.sendEventToSource({
                        ...
                        i.R.debug("Waiting for start recording event from parent.", window.location.href),
                        yield ne.waitForEventFromSource(p.g4.START_RECORDING, L)
                    } catch (e) {
                        e instanceof m.t && (i.R.debug("Could not receive post message in `init`. Timeout exceeded.", window.location.href),
                        ne.close()),
                        i.R.warn("Error happened during receiving post message from parent in `init`. Continuing normal recording.", e, window.location.href, document.visibilityState)
                    }
                }
                ))),
                Y ? (ue.isCrossOriginIframeMode = !0,
                i.R.debug("Received start recording event", Y, window.location.href),
                i.R.debug("Attaching START_RECORDING event listener.", window.location.href),
                ne.addPostMessageEventListener(p.g4.START_RECORDING, (e => {
                    var t;
                    if (!ue)
                        throw new a.f("Config is undefined",{
                            shouldReport: !0
                        });
                ...
                i.R.debug("Attaching STOP_RECORDING event listener."),
                ne.addPostMessageEventListener(p.g4.STOP_RECORDING, ( () => {
                    var e;
                    try {
                ...
                S.j)()),
                window.smartlook._loadInfo.push("Initialization - retrieving active sessions/creating new one.");
                const r = (0,
                w.f4)(ue, ae);
                let u, f, h, y, b, O;
                if (void 0 === Y) {
                ...
                try {
                    if (se.isAppliedRetryAfter() && !ye) {
                        ...
                        Z = "spamming_visitor",
                        window.smartlook._loadInfo.push("Initialization - spamming visitor."),
                        e)
                            try {
                                const t = JSON.parse(e);
                                t.code && (Z = t.code),
                        ...
                        (0,
                        v.o)(`Smartlook not recording. Reason: ${X}.`)
                    } else {
                        ...
                        if (O = e.setupData,
                        window.smartlook._loadInfo.push(`Initialization - setup call finished. Timestamp - ${Date.now()}`),
                        O.recordingAllowed) {
                            if (window.smartlook._loadInfo.push("Initialization - recording allowed"),
                            se.removeRetryAfterValues(),
                            ae.setMetadata(ue.projectKey, {
                                sessionId: u,
                                visitorId: f
                            }),
                            le.setServerTime(O.serverTime),
                            oe = !0,
                            Z = void 0,
                            X = void 0,
                            !te) {
                                try {
                                    ...
                                    window.smartlook._loadInfo.push("Initialization - bundle failed to load."),
                                    e instanceof Error && e.message.includes("is not a function") ? (0,
                                    v.o)("Smartlook could not be initialized. This site uses unsupported version of Prototype.JS library which contains some bugs. We advise you to upgrade to latest version in order to make smartlook recording. For more information do not hesitate to contact our customer support.") : (0,
                                    v.o)("Could not load smartlook bundle. Smartlook will not record this page.", {
                                        error: e
                                    }),
                                    ve = !0
                                }
                                ve || (window.smartlook._loadInfo.push("Initialization - initializing recorder."),
                                ( (e, t, o, r, n, i, s, d) => {
                                    if (void 0 === window.smartlook.recorderClass)
                                        throw new a.f("Cannot initialize Smartlook. Smartlook class is not present.");
                                    window.smartlook.recorder = new window.smartlook.recorderClass(e,t,o,r,n,i,s,d)
                                }
                                )(ue, ae, se, ie, le, ne, ce, de),
                                te = !0)
                            }
                            ve || (void 0 !== y && y < O.recording.maxRecordDuration / 3 && (u = d.$()),
                            null === (g = window.smartlook.recorder) || void 0 === g || g.startRecording(u, f, h, O, y, b))
                        } else {
                            const t = e.response
                              , o = null == t ? void 0 : t.headers.get("Retry-After");
                            o && (se.applyRetryAfter(Number.parseInt(o, 10)),
                            se.setAppliedRetryAfterReason(JSON.stringify(O.error))),
                            oe = !1,
                            X = null === (R = O.error) || void 0 === R ? void 0 : R.message,
                            Z = null === (E = O.error) || void 0 === E ? void 0 : E.code,
                            (null === (k = O.error) || void 0 === k ? void 0 : k.message) ? (0,
                            v.o)(`Smartlook not recording. Reason: ${O.error.message}.`) : (0,
                            v.o)("Smartlook not recording.")
                        }
                    }
                } catch (e) {
                    ...
                    if (e instanceof l.h) {
                        ...
                        [404, 422].includes(e.status) ? (oe = !1,
                        e.responseData && "string" != typeof e.responseData ? (X = "string" == typeof e.responseData.message ? e.responseData.message : "Unknown reason",
                        Z = "string" == typeof e.responseData.code ? e.responseData.code : "unknown_code") : (X = "Unknown reason",
                        Z = "unknown_code"),
                        (0,
                        v.o)(`Smartlook not recording. Reason: ${X}`, e.responseData),
                        "organization_not_found" !== Z && i.R.warnNoConsole(`Setup failed. Reason: ${t}.`, e, fetch.toString())) : o || ie.applyBan(new a.f(`Setup in init failed. Reason: ${t}.`,{
                            originalError: e,
                            shouldReport: !e.isConnectionError
                        }))
                    } else
                        e instanceof Error && (e.message.includes("Cannot set properties of undefined (setting 'sessionManager')") || e.message.includes("undefined is not an object (evaluating 'this.sessionManager=e')") || e.message.includes("this is undefined") || e.message.includes("Unable to set property 'sessionManager' of undefined or null reference")) ? (ve = !0,
                        (0,
                        v.o)("Smartlook could not be initialized. This site uses unsupported version of Prototype.JS library which contains some bugs. We advise you to upgrade to latest version in order to make smartlook recording. For more information do not hesitate to contact our customer support.")) : ie.applyBan(new a.f(`Setup in init failed. Reason: "${t}".`,{
            ...
            var M, L;
            if (!oe && "finish" !== e)
                return i.R.warn(`Cannot call ${e}. Recording is disabled. Reason ${null != X ? X : "unknown"}.`),
                void ("visitor_blocked" === Z && re.push([e, () => null, t]));
            ve ? i.R.debug(`Cannot call ${e}. Bundle failed to load.`) : yield( (e, t, o, ...r) => function(e, t, o, r) {
                ...
                try {
                    if (o && o.isCrossOriginIframeMode && ("string" != typeof e || ["track", "properties", "navigation", "error"].includes(e) || console.debug(`Smartlook is loaded in iframe. Calling '${e}' API in iframe is disabled. Please call it in parent page.`)),
                    "finish" === e) {
                        const e = r;
                        return void (window.smartlook.recorder ? window.smartlook.recorder.finishAllQueuedTasks(...r) : e[0]())
                    }
                    if ("stop" === e)
                        return void (window.smartlook.recorder && window.smartlook.recorder.stopRecording(...r));
                    if (t.isAppliedBan())
                        return void i.R.warn(`Cannot call smartlook API. Session is banned. Reason: ${t.getBanReason()}.`);
                    if (!window.smartlook.recorder)
                        return void i.R.warn("Smartlook is not initialized. Cannot call public api.");
                    switch (e) {
                    case "record":
                    ...
                    default:
                        ...
                        v.o)(`"${e}" is not recognised by Smartlook. See available APIs at https://web.developer.smartlook.com/docs`)
                    }
                } catch (e) {
    ...
    window.smartlook._loadInfo.push(`Init script loaded. Script source: ${window.smartlook.scriptSource}`);
    ...
    window.smartlook = Re,
    window.smartlook.isRecorderScriptLoaded = ke,
    window.smartlook.scriptSource = Oe,
    window.smartlook._loadInfo = Ie,
    window.smartlook.silent = Ae,
    Ee.forEach((e => {
        const [t,...o] = [...e];
