!function() {
    ...
    var o, e, t, n = function(o) {
        ...
        try {
            return window.sessionStorage.setItem(o, e),
            !0
        } catch (o) {
            return !1
        }
        ...
        window.smartlook.silent || console.warn.apply(console, function(o, e, t) {
            if (t || 2 === arguments.length)
                for (var n, r = 0, d = e.length; r < d; r++)
            ...
            if (!t)
                return o;
            var n, r, d = t.call(o), i = [];
            try {
                for (; (void 0 === e || e-- > 0) && !(n = d.next()).done; )
                    i.push(n.value)
            } catch (o) {
                r = {
                    error: o
        ...
        o.addEventListener("error", (function() {
            window.smartlook._loadInfo = window.smartlook._loadInfo || [],
            window.smartlook._loadInfo.push("Script module failed to load.")
        }
        ), !0);
        var e = document.createElement("script");
        e.src = w.replace("recorder.js", "es5/init.4e3e7e7f27632918efcd.js"),
        e.noModule = !0,
    ...
    if (void 0 === window.smartlook)
        ...
        window.smartlook._loadInfo = window.smartlook._loadInfo || [],
        window.smartlook._loadInfo.push("Supported device detected. Starting initialization."),
        window.smartlook.scriptSource = w.replace(/#.*$/, "").replace(/\?.*$/, "").replace(/\/[^/]+$/, "/");
        var m = document.querySelectorAll('[src$="smartlook.com/recorder.js"]');
        if (m.length > 1 && (window.smartlook._loadInfo.push("Multiple recorder scripts detected. No initialization will be done."),
        p("Smartlook web-sdk loaded ".concat(m.length, "x."))),
        window.smartlook.isRecorderScriptLoaded)
            window.smartlook._loadInfo.push("Smartlook already initialized. No initialization will be done."),
            p("Smartlook initialization ignored in this script.", document.currentScript);
        else if (a.shouldLoad())
            a.load();
        else if (u.shouldLoad())
            u.load();
        else
            try {
                !function() {
                ...
                }() ? (window.smartlook._loadInfo.push("Polyfills needs to be loaded."),
                function() {
                    ...
                    var t = function(o) {
                        var n;
                        window.smartlook._loadInfo = window.smartlook._loadInfo || [],
                        window.smartlook._loadInfo.push("Polyfills loaded load."),
                        void 0 === (n = o).isTrusted || n.isTrusted ? (e.removeEventListener("load", t, !0),
                        f()) : window.smartlook._loadInfo.push("Polyfills untrusted event.")
                    };
        ...
        window.smartlook._loadInfo = window.smartlook._loadInfo || [],
        window.smartlook._loadInfo.push("Unsupported device detected. ".concat(navigator.userAgent)),
        p("Smartlook is not recording. Unsupported browser detected.")
}();
